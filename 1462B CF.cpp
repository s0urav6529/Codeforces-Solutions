...
void solve()
{
    ...
    n--;
    int flag=0;
    if(s[0]=='2' && s[1]=='0' && s[2]=='2' && s[3]=='0') flag=1;
    else if(s[0]=='2' && s[n-2]=='0' && s[n-1]=='2' && s[n]=='0') flag=1;
    else if(s[0]=='2' && s[1]=='0' && s[n-1]=='2' && s[n]=='0') flag=1;
    else if(s[0]=='2' && s[1]=='0' && s[2]=='2' && s[n]=='0') flag=1;
    else if(s[n-3]=='2' && s[n-2]=='0' && s[n-1]=='2' && s[n]=='0') flag=1;
    if(flag) pyes;
    else pno;
    return;
    ///********************MAKE ALL THE INT LL****************************
