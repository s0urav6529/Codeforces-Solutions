    ...
    if(s<f)
    {
        while(m--)
        {
            ...
            if(t!=tt)
            {
                ...
                if((s<l || s>r ) && (s+1<l || s+1 >r)&& (s!=f)) ans+='R',s++;
                else if(s!=f) ans+='X';
            }
            else
            {
                if((s<l || s>r ) && (s+1<l || s+1 >r)) ans+='R',s++;
                else ans+='X';
            }
        }
        if(s!=f)
    ...
    else
    {
        while(m--)
        {
            ...
            if(t!=tt)
            {
                ...
                if((s<l || s>r ) && (s-1<l || s-1>r) && (s!=f)) ans+='L',s--;
                else if(s!=f) ans+='X';
            }
            else
            {
                if((s<l || s>r ) && (s-1<l || s-1>r)) ans+='L',s--;
                else ans+='X';
            }
        }
        if(s!=f)
