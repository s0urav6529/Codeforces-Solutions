...
void solve()
{
    ...
    fr1(1,j,n,1)
    {
        string x=a[j];int cnt=0;
        fr0(0,i,sz(s),1)
        {
            if(s[i]==x[i]||s[i]-32==x[i]||s[i]+32==x[i]) cnt++;
            else if(s[i]=='O'&&x[i]=='0'||s[i]=='0'&&x[i]=='O'||s[i]=='o'&&x[i]=='0'||s[i]=='0'&&x[i]=='o') cnt++;
            else if(s[i]=='1'&&x[i]=='l'||s[i]=='l'&&x[i]=='1'||s[i]=='1'&&x[i]=='I'||s[i]=='I'&&x[i]=='1'||s[i]=='l'&&x[i]=='I'||s[i]=='I'&&x[i]=='l'||s[i]=='I'&&x[i]=='L'||s[i]=='L'&&x[i]=='I') cnt++;
            else if(s[i]=='1'&&x[i]=='L'||s[i]=='L'&&x[i]=='1'||s[i]=='1'&&x[i]=='i'||s[i]=='i'&&x[i]=='1'||s[i]=='i'&&x[i]=='L'||s[i]=='L'&&x[i]=='i'||s[i]=='i'&&x[i]=='l'||s[i]=='l'&&x[i]=='i') cnt++;
        }
        if(cnt==sz(s)&&sz(s)==sz(x)) yes*=0;
    }
    if(yes) pyes;
    else pno;
    return;
