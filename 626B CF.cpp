...
void solve()
{
    ...
    {
        if(s[i]=='R') r=true,red++;
        if(s[i]=='G') g=true,green++;
        if(s[i]=='B') b=true,blue++;
    }
    if(blue==n || red==n || green==n)
    {
        if(blue==n) pf("B");
        else if(green==n) pf("G");
        else if(red==n) pf("R");
    }
    else if(b==true && r==true && g==true)
    {
        pf("BGR");
    }
    else
    {
        ...
        {
            if(r==false) pf("R");
            else if(g==false) pf("G");
            else pf("B");
            return;
        }
        if(r==false)
        {
            if(blue>1 && green>1) pf("BGR");
            else if(blue>1) pf("GR");
            else pf("BR");

        }
        else if(b==false)
        {
            if(red>1 && green>1) pf("BGR");
            else if(red>1) pf("BG");
            else pf("BR");
